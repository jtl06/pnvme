...
HD_PWD='C:/fpga/pnvme/pnvme/pnvme.runs/Top_util_vector_logic_0_2_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Top_util_vector_logic_0_2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Top_util_vector_logic_0_2.tcl
