...
HD_PWD='C:/fpga/pnvme/pnvme/pnvme.runs/Top_axi_interconnect_0_imp_s00_mmu_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Top_axi_interconnect_0_imp_s00_mmu_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Top_axi_interconnect_0_imp_s00_mmu_0.tcl
