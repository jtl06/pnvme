...
HD_PWD='C:/fpga/pnvme/pnvme/pnvme.runs/Top_axi_interconnect_1_upgraded_ipi_imp_xbar_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Top_axi_interconnect_1_upgraded_ipi_imp_xbar_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Top_axi_interconnect_1_upgraded_ipi_imp_xbar_0.tcl
