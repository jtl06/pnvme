...
HD_PWD='C:/fpga/pnvme/pnvme/pnvme.runs/Top_user_efuse_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Top_user_efuse_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Top_user_efuse_0_0.tcl
